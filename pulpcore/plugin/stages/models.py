...
class DeclarativeArtifact:
    ...
    Attributes:
        ...
        urls (List[str]): A list of many possible URLs to fetch the :class:`~pulpcore.plugin.models.Artifact` from.
    ...
    __slots__ = ("artifact", "url", "urls", "relative_path", "remote", "extra_data", "deferred_download")
